  ...
  return (
    <Box textAlign={"center"} margin={"auto"} width={"99%"}>
      <Box pl={"8px"} width={"100%"} height="200px">
        ...
        <Text fontSize={"3xl"} color={"balck.400"}>
            ...
            <Box pt={"0"} ml="5px" textAlign={"left"}>
              ...
              <Box>
                <Text color={"black.700"}>
                  Startup studio Dovetail tracks time with Harvest to build
                  trust with clients.
                </Text>
              </Box>
              <Box>
                <a href="https://www.getharvest.com/customers/dovetail">
                  {" "}
                  <button className={styles.btn}>Read customer story</button>
                </a>
              </Box>
            </Box>
          </HStack>
      ...
      <Box width={"100%"}>
        ...
        <Box mt={"60px"} width={"100%"} height="auto" mb={"2%"}>
          <Flex>
