        ...
        >
          ...
          <Box>
            ...
            <Input
              ...
              width={"400%"}
              mt={"3%"}
              placeholder="Find an app or service you use"
            />
          </Box>
        </Flex>
                  ...
                  return (
                    ...
                    >
                      <GridItem>
                        ...
                        <Box w={"100%"} h="150px">
                          <Text fontSize="xl" color="black.1300" mt={"10%"}>
                            {" "}
                            {e.name}
                          </Text>
                          <Text fontSize="md" color="black.500" mt={"10%"}>
                            {" "}
                            {e.desc}
                          </Text>
                        </Box>
        ...
        <Box mb="2%">
          <Flex>
            <VStack p={"15px"} width="30%" height={"300px"}>
              <img
                src="https://www.getharvest.com/hubfs/raw_assets/public/harvest-theme/images/illoglyphs/illo-180-integrations.svg"
                alt=""
              />
            </VStack>
              ...
              <Box p={"10px"} ml="5px" textAlign={"left"}>
                ...
                <Box>
                  <Text color={"black.700"}>
                    Extend the functionality of your app by easily adding
                    Harvest timers, or build a <br /> bespoke integration with
                    the Harvest API
                  </Text>
                </Box>
                <Box>
                  <a href="https://www.getharvest.com/add-time-tracking">
                    {" "}
                    <button className={styles.btn}>Browse options</button>
                  </a>
                </Box>
              </Box>
            </HStack>
          ...
          <Flex>
            <HStack width="50%" height={"300px"}>
              <Box p={"10px"} ml="5px" textAlign={"left"}>
                ...
                <Box>
                  <Text color={"black.700"}>
                    Join 70,000+ companies spending their time wisely with
                    Harvest.
                  </Text>
                </Box>
                <Box>
